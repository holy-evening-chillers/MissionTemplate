...
private _essentials = ["ACE_Cellphone", "ACE_Clacker", "ACE_M26_Clacker", "ACE_DefusalKit", "ACE_DeadManSwitch", "ACE_MapTools", "ACE_CableTie", "ACE_DAGR", "ACE_Flashlight_MX991", "ACE_Flashlight_KSF1", "ACE_Flashlight_XL50", "ACE_Kestrel4500", "ACE_UAVBattery", "ACE_wirecutter", "ACE_microDAGR", "ACE_RangeTable_82mm"
...
private _grenades = ["SmokeShell", "ACE_M84", "ACE_Chemlight_HiWhite", "ACE_Chemlight_HiRed", "ACE_Chemlight_HiYellow", "ACE_Chemlight_IR", "1Rnd_HE_Grenade_shell",
	"HandGrenade",
	"MiniGrenade",
	"SmokeShellRed",
	"SmokeShellGreen",
...
private _tfar = ["TFAR_anprc152", "TFAR_anprc148jem", "TFAR_fadak",
...
private _medicMaterial = ["ACE_atropine", "ACE_fieldDressing", "ACE_elasticBandage", "ACE_quikclot",
