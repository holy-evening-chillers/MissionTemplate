...
for "_i" from 1 to 2 do {_this addMagazine "1Rnd_SmokeRed_Grenade_shell";};
for "_i" from 1 to 2 do {_this addMagazine "1Rnd_SmokeGreen_Grenade_shell";};
...
switch (_loadout) do {
	...
	case 213:{
		...
		//Mütze, Gasmask, Backpack
		_this addItem "gm_gc_army_headgear_cap_80_gry";
...
_this addBackpack "TFAR_anarc210";
