...
switch (_loadout) do {
	...
	case 110 : {
		...
		_this addBackpack "rhs_weap_makarov_pmm";
...
//TODO: medic kram und pak/ chirurgen set und so
...
for "_i" from 1 to 6 do {_this addItem "ACE_tourniquet";};
for "_i" from 1 to 6 do {_this addItem "ACE_morphine";};
for "_i" from 1 to 6 do {_this addItem "ACE_epinephrine";};
for "_i" from 1 to 8 do {_this addItem "ACE_salineIV_500";};
